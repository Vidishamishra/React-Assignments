...
modifiedWeather.main.temp_min =(5*( modifiedWeather.main.temp_min -32))/9;
modifiedWeather.main.temp_max =(5*( modifiedWeather.main.temp_max -32))/9;
this.setState({
...
<ul>
<li className="list2">CITY  ::{this.state.city}</li>
{ /* const temp={this.state.isToggle} */}
<hr/>
<li className="list2">Country :: {this.state.wheather.sys.country}</li>
<li className="list2">Temp-min :: {this.state.wheather.main.temp_min}ºF </li>
<li className="list2">Temp-max :: {this.state.wheather.main.temp_max}ºF</li>
<li className="list2">Humidity :: {this.state.wheather.main.humidity} %</li>
</ul>
